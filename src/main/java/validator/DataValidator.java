...
public class DataValidator {
    ...
    private static final String REGEX_NAME = "^[a-zA-Zа-щА-ЩЬьЮюЯяЇїІіЄєҐґ *]{2,30}$";
    private static final String REGEX_NAME_NUMBER = "^[0-9a-zA-Zа-щА-ЩЬьЮюЯяЇїІіЄєҐґ *]{2,30}$";

    private static final String REGEX_NOT_LONG_STRING = "^[\\s\\S]{1,30}$";
