...
<%--&lt;%&ndash;<script>&ndash;%&gt;--%>
<%--&lt;%&ndash;    function loadDoc(id_question) {&ndash;%&gt;--%>
<%--&lt;%&ndash;        var xhttp = new XMLHttpRequest();&ndash;%&gt;--%>
<%--&lt;%&ndash;        xhttp.onreadystatechange = function () {&ndash;%&gt;--%>
<%--&lt;%&ndash;            if (this.readyState == 4 && this.status == 200) {&ndash;%&gt;--%>
<%--&lt;%&ndash;                document.getElementById("text_question").innerHTML = this.responseText;&ndash;%&gt;--%>
<%--&lt;%&ndash;            }&ndash;%&gt;--%>
<%--&lt;%&ndash;        };&ndash;%&gt;--%>
<%--&lt;%&ndash;        xhttp.open("GET", "get_text_question?id_question=" + id_question, true);&ndash;%&gt;--%>
<%--&lt;%&ndash;        xhttp.send();&ndash;%&gt;--%>
<%--&lt;%&ndash;    }&ndash;%&gt;--%>
<%--&lt;%&ndash;</script>&ndash;%&gt;--%>
