...
public abstract class AbstractCommand implements RequestHandler {
    ...
    protected String readAndSetParameterForFilter(HttpServletRequest req, String param, String defaultValue) {
    ...
    //====================================================
    protected static final String CURRENT_FILTER = "current_filter";
