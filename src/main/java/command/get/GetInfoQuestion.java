...
public class GetInfoQuestion extends AbstractCommand {
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            writer.print("<div class=\"progress\" role=\"progressbar\" aria-label=\"Basic example\" " +
                    "aria-valuenow=\"0\" aria-valuemin=\"0\" aria-valuemax=\"100\">\n" + "    " +
                    "<div class=\"progress-bar\" style=\"width: " + progress + "%\">" + progress +
                    "%</div>\n" + "</div>");
            writer.print("<input id=\"id_question\" type=\"hidden\" " + "name=\"id_question\" value=\""
                    + nextIdQuestion + "\">\n" + "    <input id=\"number_question\" type=\"hidden\" "
                    + "name=\"number_question\" value=\"" + numberQuestion + "\">");

            if (urlImage != null) {
                writer.print("<img src=\"" + urlImage + "\"" + " width=\"256\" height=\"256\" " +
            ...
            for (AnswerDto answerDto : answers) {
                writer.print(" <input type=\"checkbox\" class=\"btn-check\" " +
                        "id=\"btncheck" + answerDto.getId() + "\" name=\"res\" value=\""
                        + answerDto.getId() + "\" autocomplete=\"off\">\n" +
